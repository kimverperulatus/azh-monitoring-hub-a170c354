...
Fields to extract:
- category: Must be exactly one of: "Carebox", "Reusable Pads", "Invoice", or "Other". Rules in priority order: (1) If the document contains the text "Produktgruppe 54", always use "Carebox". (2) If the document is an invoice/Rechnung/bill for products or services, use "Invoice". (3) If the letter involves Carebox products/services, use "Carebox". (4) If it involves reusable pads/diapers/incontinence products, use "Reusable Pads". (5) If the document cannot be clearly categorized into the above, use "Other". Never use null.
